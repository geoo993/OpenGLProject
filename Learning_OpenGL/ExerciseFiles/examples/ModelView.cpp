...
struct MyApp : public App{
  ...
  void onDraw(){
    ...
    glm::vec3 eyepos = glm::vec3(0.0, 0, 2.0);
      
    glm::mat4 view = glm::lookAt( eyepos,                           //eye
                                  glm::vec3(0,0,0),                 //target
                                  glm::vec3(0,4,0) );               //up
      
    //glm::mat4 proj = glm::perspective( PI/3.0f, (float)window().ratio(), 0.1f, -20.0f);
    glm::mat4 proj = glm::perspective( PI/3.0f + (1+sin(time)), (float)window().ratio(), 0.1f, -20.0f);
