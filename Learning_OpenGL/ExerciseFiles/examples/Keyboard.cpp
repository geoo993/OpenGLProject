...
struct MyApp : public App{
  ...
  void onDraw(){
     ...
     *-----------------------------------------------------------------------------*/
    if (keyCode!=-1){
         if (keyCode==GLFW_KEY_UP) eyePos += forwardDir * .05f;//move forward
         if (keyCode==GLFW_KEY_DOWN) eyePos -= forwardDir * .05f;//move backward
         if (keyCode==GLFW_KEY_LEFT) {
          glm::quat q = glm::angleAxis(.01f, glm::vec3(0,1,0)); //rotate left
          forwardDir = q * forwardDir;
         }
         if (keyCode==GLFW_KEY_RIGHT) {
          glm::quat q = glm::angleAxis(-.01f, glm::vec3(0,1,0));//rotate right
          forwardDir = q * forwardDir;
         }
    }
