...
Mesh::Mesh(Vertex * vertices, const unsigned int &numVertices, unsigned int * indices, const unsigned int & numIndices, const bool & withIndices)
{
/////////////AFTER
    IndexedModel model;
    ...
    GenerateAndBindMeshData(model, withIndices);
    
    
/////////////BEFORE
//    m_drawCount = withIndices ? numIndices : numVertices;
//    
...
void Mesh::Draw(const bool & withIndices){
